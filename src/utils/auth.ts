...
import { exchangeNpssoForAccessCode, exchangeAccessCodeForAuthTokens, exchangeRefreshTokenForAuthTokens } from "psn-api";
...
export async function getValidAuthorization(): Promise<AuthTokens> {
  ...
  if (storedTokens?.refreshToken) {
    try {
      ...
      // Continue to get new tokens using NPSSO
    }
  }
